 ...
 * @class Core.view.ad_mobile_devices.ad_mobile_devices-listview
 */
Ext.define('Core.view.ad_mobile_devices.ad_mobile_devices-listview', { 
    extend: 'IServ.UI.Classic.ListViewPanel', 
    xtype: 'ad_mobile_devices-listview',
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'ad_mobile_devices-listview',
