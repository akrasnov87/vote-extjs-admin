/**
 * Навигация
 * @class Core.view.pd_navigations.pd_navigations___pd_navigations-collection
 */
Ext.define('Core.view.pd_navigations.pd_navigations___pd_navigations-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'pd_navigations___pd_navigations-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'pd_navigations___pd_navigations',
