/**
 * Маршруты
 * @class Core.view.cd_routes.cd_user_points___cd_routes-collection
 */
Ext.define('Core.view.cd_routes.cd_user_points___cd_routes-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'cd_user_points___cd_routes-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'cd_user_points___cd_routes',
