/**
 * Маршруты
 * @class Core.view.cd_routes.cd_route_history___cd_routes-collection
 */
Ext.define('Core.view.cd_routes.cd_route_history___cd_routes-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'cd_route_history___cd_routes-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'cd_route_history___cd_routes',
