/**
 * Тип настройки
 * @class Core.view.cs_setting_types.cd_settings___cs_setting_types-collection
 */
Ext.define('Core.view.cs_setting_types.cd_settings___cs_setting_types-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'cd_settings___cs_setting_types-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'cd_settings___cs_setting_types',
