/**
 * Операции
 * @class Core.view.sd_ui_actions.pd_accesses___sd_ui_actions-collection
 */
Ext.define('Core.view.sd_ui_actions.pd_accesses___sd_ui_actions-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'pd_accesses___sd_ui_actions-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'pd_accesses___sd_ui_actions',
