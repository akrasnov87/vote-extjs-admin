/**
 * Тип результат
 * @class Core.view.cs_result_types.cd_results___cs_result_types-collection
 */
Ext.define('Core.view.cs_result_types.cd_results___cs_result_types-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'cd_results___cs_result_types-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'cd_results___cs_result_types',
