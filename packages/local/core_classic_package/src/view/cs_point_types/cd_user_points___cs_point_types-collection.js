/**
 * Тип точки
 * @class Core.view.cs_point_types.cd_user_points___cs_point_types-collection
 */
Ext.define('Core.view.cs_point_types.cd_user_points___cs_point_types-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'cd_user_points___cs_point_types-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'cd_user_points___cs_point_types',
