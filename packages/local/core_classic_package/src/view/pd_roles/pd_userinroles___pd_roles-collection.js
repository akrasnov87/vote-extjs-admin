/**
 * Роли
 * @class Core.view.pd_roles.pd_userinroles___pd_roles-collection
 */
Ext.define('Core.view.pd_roles.pd_userinroles___pd_roles-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'pd_userinroles___pd_roles-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'pd_userinroles___pd_roles',
