/**
 * Отделения
 * @class Core.view.sd_divisions.ed_registr_pts___sd_divisions-collection
 */
Ext.define('Core.view.sd_divisions.ed_registr_pts___sd_divisions-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'ed_registr_pts___sd_divisions-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'ed_registr_pts___sd_divisions',
