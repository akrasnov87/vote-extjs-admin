/**
 * Точки
 * @class Core.view.cd_points.cd_user_points___cd_points-collection
 */
Ext.define('Core.view.cd_points.cd_user_points___cd_points-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'cd_user_points___cd_points-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'cd_user_points___cd_points',
