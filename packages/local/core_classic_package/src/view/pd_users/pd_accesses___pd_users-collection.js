/**
 * Пользователи
 * @class Core.view.pd_users.pd_accesses___pd_users-collection
 */
Ext.define('Core.view.pd_users.pd_accesses___pd_users-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'pd_accesses___pd_users-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'pd_accesses___pd_users',
