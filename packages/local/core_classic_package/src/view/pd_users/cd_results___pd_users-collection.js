/**
 * Пользователи
 * @class Core.view.pd_users.cd_results___pd_users-collection
 */
Ext.define('Core.view.pd_users.cd_results___pd_users-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'cd_results___pd_users-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'cd_results___pd_users',
