/**
 * Пользователи
 * @class Core.view.pd_users.cs_house___pd_users-collection
 */
Ext.define('Core.view.pd_users.cs_house___pd_users-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'cs_house___pd_users-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'cs_house___pd_users',
