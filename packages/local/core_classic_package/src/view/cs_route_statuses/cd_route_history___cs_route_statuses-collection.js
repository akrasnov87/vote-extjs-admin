/**
 * Тип результат
 * @class Core.view.cs_route_statuses.cd_route_history___cs_route_statuses-collection
 */
Ext.define('Core.view.cs_route_statuses.cd_route_history___cs_route_statuses-collection', { 
    ...
    items: [{
        ...
        stateful: false,
        stateId: 'cd_route_history___cs_route_statuses-collection',
        /*** дополнительные параметры передаваемые серверу */
        params: {
            viewId: 'cd_route_history___cs_route_statuses',
